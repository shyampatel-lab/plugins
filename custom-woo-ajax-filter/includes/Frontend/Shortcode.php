...
class Shortcode {
	...
	public function render( array $atts ): string {
		$atts = shortcode_atts( array( 'id' => 0 ), $atts, 'custom_product_filter' ); $set_id=absint($atts['id']); $filters=(array)get_post_meta($set_id,'_cwaf_filters',true); $relation=(string)get_post_meta($set_id,'_cwaf_relation',true);
		wp_enqueue_style('cwaf-style'); wp_enqueue_script('cwaf-script'); ob_start(); ?>
		<div class="cwaf-root" data-relation="<?php echo esc_attr($relation?:'AND');?>">
